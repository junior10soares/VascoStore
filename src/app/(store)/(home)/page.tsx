...
async function getFeaturedProducts(): Promise<Product[]> {
  const response = await api('/products/featured', {
    next: {
      revalidate: 60 * 60, // se entrar 20 usuarios a req sera feita primeira vez e depois de 1 hr apenas usando o cache
    },
  })
...
export default async function Home() {
  const [highlightedProduct, ...otherProducts] = await getFeaturedProducts()//pega os featured true e o restante
